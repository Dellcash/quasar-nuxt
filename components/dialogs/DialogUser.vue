...
<template>
  ...
  >
    <q-card
      ...
      flat
    >
      <q-card-section class="row items-center justify-between no-padding q-ma-md">
          ...
          <q-card-section class="row justify-between items-center">
            <div class="col-6 q-gutter-y-sm">
              ...
              <div class="text-caption2">
                {{ details.profile.location.province.name }}, {{ details.profile.location.city.name }}
              </div>
            </div>
            ...
            <div class="col-6">
              ...
              <div class="q-gutter-y-sm">
                <div class="row justify-between items-center">
                  ...
                  <div class="text-body3 text-weight-bold">
                  </div>
                </div>
